...
TEST(UpdateTileMasks, NoChildren) {
    validate({
        MaskedRenderable{ UnwrappedTileID{ 0, 0, 0 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
    });

    validate({
        MaskedRenderable{ UnwrappedTileID{ 4, 3, 8 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
    });

    validate({
        MaskedRenderable{ UnwrappedTileID{ 1, 0, 0 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 1, 1, 1 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
    });

    validate({
        MaskedRenderable{ UnwrappedTileID{ 1, 0, 0 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 2, 2, 3 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
    });
}
...
TEST(UpdateTileMasks, ParentAndFourChildren) {
    validate({
        ...
        MaskedRenderable{ UnwrappedTileID{ 0, 0, 0 }, TileMask{} },
        // All four covering children
        MaskedRenderable{ UnwrappedTileID{ 1, 0, 0 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 1, 0, 1 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 1, 1, 0 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 1, 1, 1 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
    });
}
...
TEST(UpdateTileMasks, Complex) {
    validate({
        ...
        MaskedRenderable{ UnwrappedTileID{ 0, { 1, 0, 0 } },
                          TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 0, { 2, 2, 2 } },
                          TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 0, { 3, 7, 7 } },
                          TileMask{ CanonicalTileID{ 0, 0, 0 } } },
        MaskedRenderable{ UnwrappedTileID{ 0, { 3, 6, 6 } },
                          TileMask{ CanonicalTileID{ 0, 0, 0 } } },
    });
    ...
    validate({
        ...
        MaskedRenderable{ UnwrappedTileID{ 4, 4, 4 }, TileMask{ CanonicalTileID{ 0, 0, 0 } } },
    });
